...
Before running the fetcher, add your local LOTR back scans to `plugins/lotr_lcg/assets`:
...
Put your deck reference into a text file in `game/decklist`. In this example, the filename is `deck.txt` and the decklist format is RingsDB (`ringsdb`).
